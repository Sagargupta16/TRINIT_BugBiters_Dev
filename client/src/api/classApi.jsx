...
export const updateClass = (id, classItem) => axiosInstance.put(`/class/update/${id}`, classItem);

export const deleteClass = (id) => axiosInstance.delete(`/class/delete/${id}`);

export const createClass = (classItem) => axiosInstance.post('/class/create', classItem);

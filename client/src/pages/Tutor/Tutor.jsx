...
const Tutor = () => {
	...
	useEffect(() => {
		const fetchUser = async () => {
			...
			const response = role === 'student' ? await getStudent(id) : await getTutor(id);
	...
	const rightComponent = (
		<div className="tutor-container">
			...
			<TutorModal isOpen={currentTutor} onClose={() => setCurrentTutor(null)} tutor={currentTutor} user={user} />
		</div>
	);
